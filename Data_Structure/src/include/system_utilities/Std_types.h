 ...
 * - Rule 8.9	:	No implicit conversion between signed and unsigned
 * types.
...
typedef unsigned char
    boolean; /* MISRA-C:2012 Rule 1.1 - No code at file scope */
typedef unsigned char
    uint8_t; /* MISRA-C:2012 Rule 1.1 - No code at file scope */
typedef unsigned long int
    uint16_t; /* MISRA-C:2012 Rule 1.1 - No code at file scope */
typedef unsigned long long int
    uint32_t_t; /* MISRA-C:2012 Rule 1.1 - No code at file scope */

/* Signed integer types */
typedef signed char sint8_t; /* MISRA-C:2012 Rule 1.1 - No code at file scope */
typedef signed long int
    sint16_t; /* MISRA-C:2012 Rule 1.1 - No code at file scope */
typedef signed long long int
    sint32_t_t; /* MISRA-C:2012 Rule 1.1 - No code at file scope */

/* Floating point types */
typedef float float32_t;  /* MISRA-C:2012 Rule 1.1 - No code at file scope */
typedef double float64_t; /* MISRA-C:2012 Rule 1.1 - No code at file scope */
...
typedef unsigned long int
    uint32_t_t; /* MISRA-C:2012 Rule 1.1 - No code at file scope */
typedef unsigned long long int
    uint64_t; /* MISRA-C:2012 Rule 1.1 - No code at file scope */
...
typedef signed int
    sint32_t_t; /* MISRA-C:2012 Rule 1.1 - No code at file scope */
typedef signed long long int
    sint64_t; /* MISRA-C:2012 Rule 1.1 - No code at file scope */
...
typedef unsigned int
    uint32_t; /* MISRA-C:2012 Rule 1.1 - No code at file scope */
typedef unsigned long long int
    uint64_t; /* MISRA-C:2012 Rule 1.1 - No code at file scope */
...
typedef signed short int
    sint16_t;                /* MISRA-C:2012 Rule 1.1 - No code at file scope */
typedef signed int sint32_t; /* MISRA-C:2012 Rule 1.1 - No code at file scope */
typedef signed long long int
    sint64_t; /* MISRA-C:2012 Rule 1.1 - No code at file scope */
...
#define uint32_tMAX                                                            \
  (4294967295u) /* MISRA-C:2012 Rule 10.1 - Avoid magic numbers */
#define UINT64MAX                                                              \
  (18446744073709551615ULL) /* MISRA-C:2012 Rule 10.1 - Avoid magic numbers */
...
#define sint32_tMAX                                                            \
  (2147483647) /* MISRA-C:2012 Rule 10.1 - Avoid magic numbers */
#define SINT64MAX                                                              \
  (9223372036854775807LL) /* MISRA-C:2012 Rule 10.1 - Avoid magic numbers */

/* Floating point Max Values */
#define FLT32_MAX                                                              \
  (3.402823466e+38F) /* MISRA-C:2012 Rule 10.1 - Avoid magic numbers */
#define FLT64_MAX                                                              \
  (1.7976931348623157e+308) /* MISRA-C:2012 Rule 10.1 - Avoid magic numbers */
...
#define FLT64_MAX_EXP                                                          \
  (1024) /* MISRA-C:2012 Rule 10.1 - Avoid magic numbers                       \
          */

/*Unsigned integer Min Values*/
#define UINT8MIN (0u)
#define UINT16MIN (0u)
#define uint32_tMIN (0u)
#define UINT64MIN (0u)

/*Signed integer Min Values*/
#define SINT8MIN (-128)
#define SINT16MIN (-32768)
#define sint32_tMIN (sint32_tMAX + 1)
