 ...
 * @details	:	This file contains functions to print various system
 *information including CPU architecture, endianness, pointer size, and data
 *type sizes.
...
static void printSignedSize(void) {
  ...
  printf("Size of sint32_t_t	: %zu bytes\n", sizeof(sint32_t_t));
...
static void printUnsignedSize(void) {
  ...
  printf("Size of uint32_t_t	: %zu bytes\n", sizeof(uint32_t_t));
...
Youefkh05			09/07/2024       1      Added Functions
Implementation
