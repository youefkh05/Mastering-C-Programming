...
/* Type definitions based on CPU type */
	...
	typedef unsigned char			uint8_t;		/* MISRA-C:2012 Rule 1.1 - No code at file scope */
	typedef unsigned long int		uint16_t;		/* MISRA-C:2012 Rule 1.1 - No code at file scope */
	typedef unsigned long long int	uint32_t;		/* MISRA-C:2012 Rule 1.1 - No code at file scope */
	
	/* Signed integer types */
	typedef signed char				sint8_t;		/* MISRA-C:2012 Rule 1.1 - No code at file scope */
	typedef signed long int			sint16_t;		/* MISRA-C:2012 Rule 1.1 - No code at file scope */
	typedef signed long long int	sint32_t;		/* MISRA-C:2012 Rule 1.1 - No code at file scope */
	...
	typedef unsigned char			boolean;	/* MISRA-C:2012 Rule 1.1 - No code at file scope */
	typedef unsigned char			uint8_t;		/* MISRA-C:2012 Rule 1.1 - No code at file scope */
	typedef unsigned short int		uint16_t;		/* MISRA-C:2012 Rule 1.1 - No code at file scope */
	typedef unsigned long int		uint32_t;		/* MISRA-C:2012 Rule 1.1 - No code at file scope */
	typedef unsigned long long int	uint64_t;		/* MISRA-C:2012 Rule 1.1 - No code at file scope */
	
	/* Signed integer types */
	typedef signed char				sint8_t;		/* MISRA-C:2012 Rule 1.1 - No code at file scope */
	typedef signed short int		sint16_t;		/* MISRA-C:2012 Rule 1.1 - No code at file scope */
	typedef signed int				sint32_t;		/* MISRA-C:2012 Rule 1.1 - No code at file scope */
	typedef signed long long int	sint64_t;		/* MISRA-C:2012 Rule 1.1 - No code at file scope */
	...
	typedef unsigned char			uint8_t;		/* MISRA-C:2012 Rule 1.1 - No code at file scope */
	typedef unsigned short int		uint16_t;		/* MISRA-C:2012 Rule 1.1 - No code at file scope */
	typedef unsigned int			uint32_t;		/* MISRA-C:2012 Rule 1.1 - No code at file scope */
	typedef unsigned long long int	uint64_t;		/* MISRA-C:2012 Rule 1.1 - No code at file scope */
